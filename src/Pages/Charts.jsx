  ...
  return (
    <div style={{ marginTop: "10px", overflow: "hidden" }}>
      ...
      <div style={{padding:"10px",margin: "10px", marginTop: "80px",}}>
        <div style={{height:"100%",width:"100%",border: "1px solid rgba(160, 27, 255, 0.26)", display: "flex",padding:"20px",borderRadius:"10px",color:"white", display:"flex",alignItems:"center",justifyContent:"space-between",gap:"20px"
        }}>
          <h1>{search.toUpperCase()}</h1>
          {user && <button onClick={handleAddToWatchlist} style={btnStyles}><SlScreenDesktop /> Add to Watchlist</button>}
        </div>
      ...
      <div style={{ padding: "20px" }}>
        <div style={{ display: "flex", width: "100%", gap: "20px", zIndex: "20", overflow: "hidden", borderRadius: "10px", boxShadow: "0px 20px 207px 10px rgba(165, 39, 255, 0.48)", border: "2px solid rgba(165, 39, 255,1)", marginBottom: "20px", marginTop: "70px", height: "100%", padding: "20px" }}>
          <div style={{ flex: 1 }}>
