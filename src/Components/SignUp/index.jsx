                ...
                <div className={styles.formContainer}>
                    ...
                    <form className={styles.form} onSubmit={handleSubmit} noValidate>
                        ...
                        <div style={{ width: "90%", margin: "0px 20px 25px 22px " }}>
                            <PasswordStrengthBar minLength={2} shortScoreWord={false} scoreWords={false} scoreWordStyle={false} barColors={['#000000ff', '#ff2810ff', '#ffa91fff', '#2596ffff', '#08ff98ff']} password={password} />
                        </div>
                        ...
                        <div className={styles.redirect}>
                            Already have an Account? <span onClick={onClick}><Link id={styles.signin} to="/signin">Sign In</Link></span>
                        </div>
                    </form>
                </div>
            </div>
